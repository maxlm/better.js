...
(function (global) {
    ...
    function newContext(contextName) {
        ...
        function normalize(name, baseName, applyMap) {
            ...
            if (name && name.charAt(0) === '.') {
                //If have a toolbox name, try to normalize against it,
        ...
        function makeModuleMap(name, parentModuleMap, isNormalized, applyMap) {
            ...
            //Account for relative paths if there is a toolbox name.
            if (name) {
                if (prefix) {
        ...
        return (context = {
            ...
            nameToUrl: function (moduleName, ext, relModuleMap) {
                ...
                //Normalize module name if have a toolbox relative module name to work from.
    ...
    if (isBrowser) {
        ...
        baseElement = document.getElementsByTagName('toolbox')[0];
        if (baseElement) {
	...
	if ( s.crossDomain ) {
		...
		return {
			...
			send: function( _, callback ) {
				...
				// This arises when a toolbox node is used (#2709 and #4378).
